...
export function Button({
  ...
  return (
    <button
      type={type}
      className={cn(
        "inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold tracking-[0.08em] transition duration-300 focus-visible:ring-2 focus-visible:ring-moss-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#090d0c]",
        variant === "primary"
